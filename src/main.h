...
static const int64 MAX_MONEY = 41000000 * COIN;
static const int64 MAX_MINT_PROOF_OF_WORK = 5 * COIN;	
static const int64 MAX_MINT_PROOF_OF_STAKE = 0 * MAX_MINT_PROOF_OF_WORK;	
static const int64 MIN_TXOUT_AMOUNT = MIN_TX_FEE;
static const unsigned int MAX_TX_COMMENT_LEN = 268; // Ocoin: 256 bytes + 12 little extra
...
static const uint256 hashGenesisBlockOfficial("0x000000030fd61d0fa47b0e9bbb046079408b6879e5d6c1a77349836f47164a16");
...
void GenerateOcoins(bool fGenerate, CWallet* pwallet);
...
void OcoinMiner(CWallet *pwallet, bool fProofOfStake);
...
public:
    ...
    */
    ...
    /** Amount of Ocoins spent by this transaction.
    ...
    /** Amount of Ocoins coming in to this transaction
...
public:
    ...
    {
        // Protocol switch to support p2pool at Ocoin block #9689
        ...
        // Before Ocoin block #9689 - old protocol
